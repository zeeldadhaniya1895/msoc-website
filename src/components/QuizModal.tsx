      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="card relative z-10 max-w-md w-full"
          >
            <div className="text-center">
              <div className="text-5xl mb-4 summer-icon">🧩</div>
              <h2 className="text-2xl font-display font-bold text-summer-yellow mb-4">
                Quiz Coming Soon!
              </h2>
              <p className="text-white/80 mb-6">
                The quiz for this track is not planned yet. Please check back later or join our Discord server for updates.
              </p>
